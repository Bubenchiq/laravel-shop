        ...
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                <div class="pull-right">
                    <a class="btn btn-black" href="{{ route('manager.products.create') }}"> Create New Product</a>
                </div>
            </h2>
        </x-slot>
    </div>
                ...
                <td width="150">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <form action="{{ route('manager.products.destroy',$product->id) }}" method="POST">
                            <a class="btn btn-black" href="{{ route('manager.products.show',$product->id) }}">Show</a>
                        </form>

                        <a class="btn btn-black" href="{{ route('manager.products.edit',$product->id) }}">Edit</a>
